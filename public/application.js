...
/***/ (function(module, exports, __webpack_require__) {
	...
	var vacationEvents = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpSuccess = function signUpSuccess(resp) {
	...
	var signInSuccess = function signInSuccess(resp) {
	...
	var loggedInSuccess = function loggedInSuccess() {
	  $("#sign-in")[0].reset();
	  $('#signIn').hide();
	  $('#logbox').hide();
	  $('.vacation-show').show();
	...
	var passwordChangeFailure = function passwordChangeFailure(err) {
	  if (err.status === 400) {
	...
	var passwordChangeSuccess = function passwordChangeSuccess() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateVacation = function onCreateVacation(event) {
	  var data = getFormFields(event.target);
	  // console.log('Data: ', data);
	  event.preventDefault();
	  api.createVacation(data).then(function (response) {
	    store.vacation = response.vacation;
	    onGetVacations();
	  }).then(ui.createVacationSuccess).catch(ui.createVacationFailure);
	};

	var onGetVacations = function onGetVacations() {
	  api.getVacations().then(function (response) {
	    store.vacations = response.vacations;
	    ui.getVacationSuccess();
	  }).catch(ui.getVacationFailure);
	};

	var onUpdateVacation = function onUpdateVacation(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateVacation(data).then(ui.updateVacationSuccess).then(function () {
	    onGetVacations();
	    $('#editModal').modal('hide');
	  }).catch(ui.UpdateVacationFailure);
	};

	var openEditModal = function openEditModal(event) {
	  event.preventDefault();
	  var vacationId = $(this).data().vacationid;
	  var currentVacation = store.vacations.filter(function (vacation) {
	...
	var onRemoveVacation = function onRemoveVacation(event) {
	  var vacationId = $(this).data().vacationid;
	  var data = getFormFields(event.target);
	  // console.log('Data: ', data);
	  event.preventDefault();
	  api.removeVacation(data.vacation.id).then(ui.removeVacationSuccess).then(onGetVacations).catch(ui.removeVacaFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createVacation = function createVacation(data) {
	  return $.ajax({
	...
	var getVacations = function getVacations() {
	  return $.ajax({
	    url: config.apiOrigin + '/vacations',
	    method: 'GET',
	    headers: {
	...
	var updateVacation = function updateVacation(data) {
	  return $.ajax({
	...
	var removeVacation = function removeVacation(id) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var vacationTemplate = __webpack_require__(15);

	var createVacationSuccess = function createVacationSuccess() {
	...
	var createVacationFailure = function createVacationFailure(err) {
	  if (err.status === 400) {
	...
	var getVacationSuccess = function getVacationSuccess() {
	  ...
	  var vacations = vacationTemplate({
	...
	var updateVacationSuccess = function updateVacationSuccess() {
	  $('#editModal').modal('hide');
	...
	var removeVacationSuccess = function removeVacationSuccess() {
	  $('#delete-vacation').val('');
	...
	var removeVacationFailure = function removeVacationFailure() {
	...
	module.exports = {
	  createVacationSuccess: createVacationSuccess,
	  createVacationFailure: createVacationFailure,
	  getVacationSuccess: getVacationSuccess,
	  updateVacationSuccess: updateVacationSuccess,
	  removeVacationSuccess: removeVacationSuccess,
	  removeVacationFailure: removeVacationFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div>\n    Vacation ID: "
	    ...
	    + " <br />\n    City: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.city : stack1), depth0))
	    + " <br />\n    Name: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + " <br />\n    <!-- Visited: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.visited : stack1), depth0))
	    + " <br /> -->\n    Comments: "
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.vacations : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
